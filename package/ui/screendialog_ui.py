...
class Ui_screenDialog(object):
    def setupUi(self, screenDialog):
        ...
        self.formScreen.setWidget(1, QtGui.QFormLayout.LabelRole, self.rbScreenVideo)
        self.rbScreenColor = QtGui.QRadioButton(screenDialog)
        self.rbScreenColor.setObjectName(_fromUtf8("rbScreenColor"))
        self.formScreen.setWidget(1, QtGui.QFormLayout.FieldRole, self.rbScreenColor)
        ...
        self.formScreen.setWidget(2, QtGui.QFormLayout.LabelRole, self.pbScreenVideo)
        ...
        self.formScreen.setWidget(2, QtGui.QFormLayout.FieldRole, self.leScreenVideo)
        self.pbScreenColor = QtGui.QPushButton(screenDialog)
        self.pbScreenColor.setObjectName(_fromUtf8("pbScreenColor"))
        self.formScreen.setWidget(3, QtGui.QFormLayout.LabelRole, self.pbScreenColor)
        ...
        self.formScreen.setWidget(3, QtGui.QFormLayout.FieldRole, self.leScreenColor)
